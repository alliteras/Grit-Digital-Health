...
<body>
    <div id="main" class="hidden">
        ...
        <nav>
          <ul class="desktop">
              <li class="text-link"><a href="product/" data-target="-1" class="product-link">PRODUCT</a></li>
        ...
        <section class="hero">
        	<div class="hero-wrap">
                <h1>Technology <br />— <span>Transcends</span></h1>
                <a href="product/">See the YOU portal  &nbsp;<img src="img/arrow-right.png" alt="arrow"/></a>
            </div>
        </section>
        ...
        <section class="YOU product-feature">
                <div class="left">
                    <img src="img/YOU_Triad.png" alt="YOU-triad"/>
                </div>
                <div class="right">
    	...
    	<section class="about" id="about">
    		<div>
                ...
                <a href="newsroom/" class="button">Visit the Grit Newsroom</a>
      		</div>
       </section>
       <section class="full-img skylight"></section>
   <footer>
